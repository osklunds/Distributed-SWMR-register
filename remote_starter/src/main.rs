...
fn run_function_on_each_unique_host_in_parallell(function_to_run: &Fn(&NodeInfo) -> Child) {
...
fn run_function_on_all_hosts_in_parallell(function_to_run: &Fn(&NodeInfo) -> Child) {
